...
type BarcodeScannerProps = {
  onScanFinished: (results: string[]) => void;
};

export default function BarcodeScanner({ onScanFinished }: BarcodeScannerProps) {
