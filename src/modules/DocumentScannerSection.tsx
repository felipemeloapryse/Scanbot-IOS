    ...
    <View>
      ...
      >
        <ModuleCard
          ...
          description="Create high quality document scans with user guidance and edge detection"
          icon="document-text-outline"
          onPress={startDocumentScannerService}
        />
        <ModuleCard
          title="Run OCR on Document Scan"
          description="Create a high quality scan, extract all text elements, and export as searchable PDF"
          icon="search-outline"
          onPress={runOcrAndOpenViewer}
        />
      </ScrollView>
      <WebviewerModal
