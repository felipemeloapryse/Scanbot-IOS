    ...
    <View>
      ...
      >
        ...
        <ModuleCard
          ...
          icon="scan-outline"
          onPress={startMrzScannerService}
        />
        ...
        <ModuleCard
          ...
          icon="person-outline"
          onPress={startGermanIdScannerService}
        />
        ...
        <ModuleCard
          ...
          icon="medkit-outline"
          onPress={startEhicScannerService}
        />
