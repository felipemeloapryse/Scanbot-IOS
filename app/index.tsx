...
import SdkModulesFilter, {
  SdkFilter,
} from "../src/components/SdkModulesFilter";
...
export default function Home() {
  ...
  const [selectedFilter, setSelectedFilter] = useState<SdkFilter>("All");

  const [modalVisible, setModalVisible] = useState(false);
  const [scannedItems, setScannedItems] = useState<string[]>([]);

  function handleScanFinished(results: string[]) {
