...
exports.ResamplingMethodValues = exports.PdfConfiguration = exports.PdfAttributes = exports.PageSizeValues = exports.PageFitValues = exports.PageDirectionValues = void 0;
...
PDF attributes.
*/
class PdfAttributes extends _utils.PartiallyConstructible {
  /**
    Author.
    
    Default is "Created with Scanbot SDK"
    */
  author = 'Created with Scanbot SDK';
  /**
    Creator.
...
*/
exports.PdfAttributes = PdfAttributes;
const PageSizeValues = exports.PageSizeValues = ['LETTER', 'LEGAL', 'A3', 'A4', 'A5', 'B4', 'B5', 'EXECUTIVE', 'US4x6', 'US4x8', 'US5x7', 'COMM10', 'CUSTOM'];
...
const PageDirectionValues = exports.PageDirectionValues = ['PORTRAIT', 'LANDSCAPE', 'AUTO'];
...
const PageFitValues = exports.PageFitValues = ['FIT_IN', 'FILL_IN', 'STRETCH', 'NONE'];
...
const ResamplingMethodValues = exports.ResamplingMethodValues = ['NONE', 'NEAREST', 'LINEAR', 'CUBIC', 'LANCZOS4', 'AREA'];
...
*/
class PdfConfiguration extends _utils.PartiallyConstructible {
  /**
    Attributes.
    */
