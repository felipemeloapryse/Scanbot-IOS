...
exports.CommonBarcodeScannerConfiguration = void 0;
var _utils = require("../../utils/utils");
/// Auto-generated with ScanbotSDKCodegenV3. Modifications will be overwritten.
/// Generated from rtu-ui-v2/schemas/barcode/BarcodeScannerConfiguration.yaml

/**
Configuration of the scanning behavior.
*/
class CommonBarcodeScannerConfiguration extends _utils.PartiallyConstructible {
  /**
  ...
  /**
    ...
    */
  barcodeFormats = ['AZTEC', 'CODABAR', 'CODE_39', 'CODE_93', 'CODE_128', 'DATA_MATRIX', 'DATABAR', 'DATABAR_EXPANDED', 'DATABAR_LIMITED', 'EAN_13', 'EAN_8', 'ITF', 'MICRO_QR_CODE', 'PDF_417', 'QR_CODE', 'UPC_A', 'UPC_E'];
  /**
  ...
  constructor(source = {}) {
    ...
    if (source.barcodeFormats !== undefined) {
      this.barcodeFormats = source.barcodeFormats.map(it => {
        return it;
      });
    }
...
exports.CommonBarcodeScannerConfiguration = CommonBarcodeScannerConfiguration;
//# sourceMappingURL=BarcodeScannerConfiguration.js.map