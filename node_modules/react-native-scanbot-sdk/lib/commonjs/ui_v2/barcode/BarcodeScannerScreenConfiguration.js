...
exports.BarcodeScannerScreenConfiguration = void 0;
var _BarcodeScannerConfiguration = require("../../ui_v2/barcode/BarcodeScannerConfiguration");
var _BarcodeTextLocalization = require("../../ui_v2/barcode/BarcodeTextLocalization");
var _BarcodeUseCase = require("../../ui_v2/barcode/BarcodeUseCase");
var _SingleScanningModeUseCase = require("../../ui_v2/barcode/SingleScanningModeUseCase");
...
*/
class BarcodeScannerScreenConfiguration extends _utils.PartiallyConstructible {
  /**
  ...
  /**
    ...
    */
  localization = new _BarcodeTextLocalization.BarcodeTextLocalization({});
  /**
  ...
  /**
    ...
    */
  scannerConfiguration = new _BarcodeScannerConfiguration.CommonBarcodeScannerConfiguration({});
  /**
    Configuration of the barcode scanner screen's behavior.
    */
  useCase = new _SingleScanningModeUseCase.SingleScanningMode({});
  /**
  ...
  constructor(source = {}) {
    ...
    if (source.localization !== undefined) {
      this.localization = new _BarcodeTextLocalization.BarcodeTextLocalization(source.localization);
    }
    ...
    if (source.userGuidance !== undefined) {
      this.userGuidance = new _UserGuidanceConfiguration.UserGuidanceConfiguration(source.userGuidance);
    }
    ...
    if (source.scannerConfiguration !== undefined) {
      this.scannerConfiguration = new _BarcodeScannerConfiguration.CommonBarcodeScannerConfiguration(source.scannerConfiguration);
    }
    if (source.useCase !== undefined) {
      this.useCase = _BarcodeUseCase.BarcodeUseCase.From(source.useCase);
    }
...
exports.BarcodeScannerScreenConfiguration = BarcodeScannerScreenConfiguration;
//# sourceMappingURL=BarcodeScannerScreenConfiguration.js.map