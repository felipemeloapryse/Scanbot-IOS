...
exports.ResultAccumulationConfiguration = exports.ConfirmationMethodValues = exports.AccumulatedResultsVerifierConfiguration = void 0;
...
const ConfirmationMethodValues = exports.ConfirmationMethodValues = ['EXACT', 'INTERPOLATE'];

/**
Configuration for how to accumulate results.
*/
class ResultAccumulationConfiguration extends _utils.PartiallyConstructible {
  /**
    Method used to confirm a result.
  ...
  /**
    ...
    Default is 0.8
    */
  minConfidenceForStableField = 0.8;
  /**
...
*/
exports.ResultAccumulationConfiguration = ResultAccumulationConfiguration;
class AccumulatedResultsVerifierConfiguration extends _utils.PartiallyConstructible {
  /**
...
exports.AccumulatedResultsVerifierConfiguration = AccumulatedResultsVerifierConfiguration;
