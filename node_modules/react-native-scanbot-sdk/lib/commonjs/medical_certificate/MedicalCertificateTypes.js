...
exports.MedicalCertificateScanningResult = exports.MedicalCertificateScanningParameters = exports.MedicalCertificatePatientInfoFieldTypeValues = exports.MedicalCertificatePatientInfoField = exports.MedicalCertificatePatientInfoBox = exports.MedicalCertificateFormTypeValues = exports.MedicalCertificateDateRecordTypeValues = exports.MedicalCertificateDateRecord = exports.MedicalCertificateCheckBoxTypeValues = exports.MedicalCertificateCheckBox = void 0;
...
*/
class MedicalCertificateScanningParameters extends _utils.PartiallyConstructible {
  /**
...
*/
exports.MedicalCertificateScanningParameters = MedicalCertificateScanningParameters;
const MedicalCertificateCheckBoxTypeValues = exports.MedicalCertificateCheckBoxTypeValues = ['UNKNOWN', 'WORK_ACCIDENT', 'ASSIGNED_TO_ACCIDENT_INSURANCE_DOCTOR', 'INITIAL_CERTIFICATE', 'RENEWED_CERTIFICATE', 'INSURED_PAY_CASE', 'FINAL_CERTIFICATE', 'REQUIRES_CARE_YES', 'REQUIRES_CARE_NO', 'ACCIDENT_YES', 'ACCIDENT_NO', 'OTHER_ACCIDENT', 'ENTITLEMENT_TO_CONTINUED_PAYMENT_YES', 'ENTITLEMENT_TO_CONTINUED_PAYMENT_NO', 'SICK_PAY_WAS_CLAIMED_NO', 'SICK_PAY_WAS_CLAIMED_YES', 'SINGLE_PARENT_NO', 'SINGLE_PARENT_YES'];

/**
Structure to contain full information about found box.
*/
class MedicalCertificateCheckBox extends _utils.PartiallyConstructible {
  /**
    Box type.
...
- `UNDEFINED`:
   Undefined date type.
*/
exports.MedicalCertificateCheckBox = MedicalCertificateCheckBox;
const MedicalCertificateDateRecordTypeValues = exports.MedicalCertificateDateRecordTypeValues = ['INCAPABLE_OF_WORK_SINCE', 'INCAPABLE_OF_WORK_UNTIL', 'DIAGNOSED_ON', 'DOCUMENT_DATE', 'BIRTH_DATE', 'CHILD_NEEDS_CARE_FROM', 'CHILD_NEEDS_CARE_UNTIL', 'UNDEFINED'];

/**
Structure to contain date record information.
*/
class MedicalCertificateDateRecord extends _utils.PartiallyConstructible {
  /**
    Date box.
    */
...
- `UNDEFINED`:
   Undefined.
*/
exports.MedicalCertificateDateRecord = MedicalCertificateDateRecord;
const MedicalCertificatePatientInfoFieldTypeValues = exports.MedicalCertificatePatientInfoFieldTypeValues = ['INSURANCE_PROVIDER', 'FIRST_NAME', 'LAST_NAME', 'ADDRESS_STRING1', 'ADDRESS_STRING2', 'DIAGNOSE', 'HEALTH_INSURANCE_NUMBER', 'INSURED_PERSON_NUMBER', 'STATUS', 'PLACE_OF_OPERATION_NUMBER', 'DOCTOR_NUMBER', 'UNDEFINED'];

/**
Patient information field.
*/
class MedicalCertificatePatientInfoField extends _utils.PartiallyConstructible {
  /**
    Field type.
    */
...
*/
exports.MedicalCertificatePatientInfoField = MedicalCertificatePatientInfoField;
class MedicalCertificatePatientInfoBox extends _utils.PartiallyConstructible {
  /**
...
- `FORM_1B_CUSTOM`:
   Form 1B custom.
*/
exports.MedicalCertificatePatientInfoBox = MedicalCertificatePatientInfoBox;
const MedicalCertificateFormTypeValues = exports.MedicalCertificateFormTypeValues = ['UNKNOWN', 'FORM_1A', 'FORM_1B', 'FORM_1C', 'FORM_1D', 'FORM_21A', 'FORM_21A_BACK', 'FORM_1B_CUSTOM'];

/**
The result of the medical certificate scanning.
*/
class MedicalCertificateScanningResult extends _utils.PartiallyConstructible {
  /**
  ...
  constructor(source = {}) {
    ...
    if (source.croppedImage !== undefined) {
      this.croppedImage = source.croppedImage != null ? _image.ImageRef.From(source.croppedImage) : null;
    }
    ...
    if (source.documentDetectionResult !== undefined) {
      this.documentDetectionResult = source.documentDetectionResult != null ? new _DocumentScannerTypes.DocumentDetectionResult(source.documentDetectionResult) : null;
    } else {
...
exports.MedicalCertificateScanningResult = MedicalCertificateScanningResult;
