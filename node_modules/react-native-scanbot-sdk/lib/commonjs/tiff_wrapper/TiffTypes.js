...
exports.UserFieldValue = exports.UserFieldStringValue = exports.UserFieldIntValue = exports.UserFieldDoubleValue = exports.UserField = exports.TiffGeneratorParameters = exports.CompressionModeValues = exports.BinarizationValues = void 0;
...
const CompressionModeValues = exports.CompressionModeValues = ['NONE', 'CCITTRLE', 'CCITT_T4', 'CCITT_T6', 'LZW', 'JPEG', 'CCITTRLEW', 'PACKBITS', 'DEFLATE', 'ADOBE_DEFLATE'];
...
const BinarizationValues = exports.BinarizationValues = ['DISABLED', 'ENABLED', 'ENABLED_IF_BINARIZATION_FILTER_SET'];

/**
User-defined TIFF field value.
*/
/** @internal */
let UserFieldValue = exports.UserFieldValue = void 0;
...
})(UserFieldValue || (exports.UserFieldValue = UserFieldValue = {}));
/**
Double value (TIFF_DOUBLE).
*/
class UserFieldDoubleValue extends _utils.PartiallyConstructible {
...
*/
exports.UserFieldDoubleValue = UserFieldDoubleValue;
class UserFieldStringValue extends _utils.PartiallyConstructible {
...
*/
exports.UserFieldStringValue = UserFieldStringValue;
class UserFieldIntValue extends _utils.PartiallyConstructible {
...
*/
exports.UserFieldIntValue = UserFieldIntValue;
class UserField extends _utils.PartiallyConstructible {
  /**
    Numeric tag.
    */
...
class TiffGeneratorParameters extends _utils.PartiallyConstructible {
  /**
    Compression.
  ...
  constructor(source = {}) {
    ...
    if (source.binarizationFilter !== undefined) {
      this.binarizationFilter = source.binarizationFilter != null ? _ParametricFilters.ParametricFilter.From(source.binarizationFilter) : null;
    }
  }
}
exports.TiffGeneratorParameters = TiffGeneratorParameters;
...
})(TiffGeneratorParameters || (exports.TiffGeneratorParameters = TiffGeneratorParameters = {}));
