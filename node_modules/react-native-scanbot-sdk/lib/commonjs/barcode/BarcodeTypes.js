...
exports.UpcEanExtensionBehaviorValues = exports.StructuredAppendInfo = exports.RangeEncoding = exports.Gs1HandlingValues = exports.CharacterEncodingValues = exports.BarcodeFormats = exports.BarcodeFormatValues = void 0;
...
class RangeEncoding extends _utils.PartiallyConstructible {
  ...
  constructor(source = {}) {
    ...
    if (source.encoding !== undefined) {
      ...
      throw new Error('encoding must be present in constructor argument');
    }
  }
...
*/
exports.RangeEncoding = RangeEncoding;
class StructuredAppendInfo extends _utils.PartiallyConstructible {
  /**
  ...
  constructor(source = {}) {
    ...
    if (source.index !== undefined) {
      ...
      throw new Error('index must be present in constructor argument');
    }
    if (source.id !== undefined) {
      this.id = source.id;
    } else {
      throw new Error('id must be present in constructor argument');
    }
  }
  serialize(config = new _JsonSerializationTypes.ToJsonConfiguration()) {
    return {
...
*/
exports.StructuredAppendInfo = StructuredAppendInfo;
const BarcodeFormatValues = exports.BarcodeFormatValues = ['NONE', 'AZTEC', 'CODABAR', 'CODE_39', 'CODE_93', 'CODE_128', 'DATA_MATRIX', 'EAN_8', 'EAN_13', 'ITF', 'MAXI_CODE', 'PDF_417', 'QR_CODE', 'DATABAR', 'DATABAR_EXPANDED', 'UPC_A', 'UPC_E', 'MSI_PLESSEY', 'IATA_2_OF_5', 'INDUSTRIAL_2_OF_5', 'CODE_25', 'MICRO_QR_CODE', 'USPS_INTELLIGENT_MAIL', 'ROYAL_MAIL', 'JAPAN_POST', 'ROYAL_TNT_POST', 'AUSTRALIA_POST', 'DATABAR_LIMITED', 'MICRO_PDF_417', 'GS1_COMPOSITE', 'RMQR_CODE', 'CODE_11', 'CODE_32', 'PHARMA_CODE', 'PHARMA_CODE_TWO_TRACK', 'PZN_7', 'PZN_8'];

/**
Lists of barcode formats to decode.
*/
class BarcodeFormats extends _utils.PartiallyConstructible {
...
exports.BarcodeFormats = BarcodeFormats;
(function (_BarcodeFormats) {
  const oned = _BarcodeFormats.oned = ['CODABAR', 'CODE_11', 'CODE_25', 'CODE_32', 'CODE_39', 'CODE_93', 'CODE_128', 'DATABAR', 'DATABAR_EXPANDED', 'DATABAR_LIMITED', 'EAN_8', 'EAN_13', 'IATA_2_OF_5', 'INDUSTRIAL_2_OF_5', 'ITF', 'MSI_PLESSEY', 'PHARMA_CODE', 'PZN_7', 'PZN_8', 'UPC_A', 'UPC_E'];
  const twod = _BarcodeFormats.twod = ['AZTEC', 'DATA_MATRIX', 'MAXI_CODE', 'MICRO_QR_CODE', 'MICRO_PDF_417', 'PDF_417', 'QR_CODE', 'RMQR_CODE'];
  const postal = _BarcodeFormats.postal = ['AUSTRALIA_POST', 'JAPAN_POST', 'ROYAL_MAIL', 'ROYAL_TNT_POST', 'USPS_INTELLIGENT_MAIL'];
  const pharma = _BarcodeFormats.pharma = ['CODE_32', 'PHARMA_CODE', 'PHARMA_CODE_TWO_TRACK', 'PZN_7', 'PZN_8'];
  const common = _BarcodeFormats.common = ['AZTEC', 'CODABAR', 'CODE_39', 'CODE_93', 'CODE_128', 'DATA_MATRIX', 'DATABAR', 'DATABAR_EXPANDED', 'DATABAR_LIMITED', 'EAN_13', 'EAN_8', 'ITF', 'MICRO_QR_CODE', 'PDF_417', 'QR_CODE', 'UPC_A', 'UPC_E'];
  const all = _BarcodeFormats.all = ['AUSTRALIA_POST', 'AZTEC', 'CODABAR', 'CODE_11', 'CODE_25', 'CODE_32', 'CODE_39', 'CODE_93', 'CODE_128', 'DATA_MATRIX', 'DATABAR', 'DATABAR_EXPANDED', 'DATABAR_LIMITED', 'EAN_13', 'EAN_8', 'GS1_COMPOSITE', 'IATA_2_OF_5', 'INDUSTRIAL_2_OF_5', 'ITF', 'JAPAN_POST', 'MAXI_CODE', 'MICRO_PDF_417', 'MICRO_QR_CODE', 'MSI_PLESSEY', 'PDF_417', 'PHARMA_CODE', 'PHARMA_CODE_TWO_TRACK', 'PZN_7', 'PZN_8', 'QR_CODE', 'RMQR_CODE', 'ROYAL_MAIL', 'ROYAL_TNT_POST', 'UPC_A', 'UPC_E', 'USPS_INTELLIGENT_MAIL'];
...
*/
const Gs1HandlingValues = exports.Gs1HandlingValues = ['PARSE', 'VALIDATE_STRUCTURE', 'DECODE_STRUCTURE', 'VALIDATE_FULL', 'DECODE_FULL'];
...
const UpcEanExtensionBehaviorValues = exports.UpcEanExtensionBehaviorValues = ['REQUIRE_2', 'REQUIRE_5', 'REQUIRE_ANY', 'IGNORE', 'ALLOW_2', 'ALLOW_5', 'ALLOW_ANY'];
//# sourceMappingURL=BarcodeTypes.js.map