...
*/
class BarcodeFormatCodabarConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatCode39Configuration extends _utils.PartiallyConstructible {
...
class BarcodeFormatCode93Configuration extends _utils.PartiallyConstructible {
...
class BarcodeFormatCode128Configuration extends _utils.PartiallyConstructible {
...
class BarcodeFormatCode2Of5Configuration extends _utils.PartiallyConstructible {
...
class BarcodeFormatDataBarConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatDataBarExpandedConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatDataBarLimitedConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatItfConfiguration extends _utils.PartiallyConstructible {
...
*/
class BarcodeFormatMsiPlesseyConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatUpcEanConfiguration extends _utils.PartiallyConstructible {
  ...
  /**
    ...
    Default is 1
    */
  minimumNumberOfRequiredFramesWithEqualRecognitionResultExtensionless = 1;
  ...
  constructor(source = {}) {
    ...
    if (source.ean13 !== undefined) {
      this.ean13 = source.ean13;
    }
    if (source.upca !== undefined) {
      this.upca = source.upca;
    }
    if (source.upce !== undefined) {
      this.upce = source.upce;
    }
    ...
    if (source.minimumNumberOfRequiredFramesWithEqualRecognitionResultExtensionless !== undefined) {
      this.minimumNumberOfRequiredFramesWithEqualRecognitionResultExtensionless = source.minimumNumberOfRequiredFramesWithEqualRecognitionResultExtensionless;
    }
  }
}
...
class BarcodeFormatPharmaCodeConfiguration extends _utils.PartiallyConstructible {
  ...
  constructor(source = {}) {
    ...
    if (source.allowNarrowBarsOnly !== undefined) {
      this.allowNarrowBarsOnly = source.allowNarrowBarsOnly;
    }
    if (source.allowWideBarsOnly !== undefined) {
      this.allowWideBarsOnly = source.allowWideBarsOnly;
    }
  }
}
...
*/
exports.BarcodeFormatPharmaCodeConfiguration = BarcodeFormatPharmaCodeConfiguration;
/** @internal */
...
*/
class BarcodeFormatAztecConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatQrCodeConfiguration extends _utils.PartiallyConstructible {
  ...
  constructor(source = {}) {
    ...
    if (source.microQr !== undefined) {
      this.microQr = source.microQr;
    }
    if (source.rmqr !== undefined) {
      this.rmqr = source.rmqr;
    }
  }
}
...
class BarcodeFormatPdf417Configuration extends _utils.PartiallyConstructible {
...
class BarcodeFormatMicroPdf417Configuration extends _utils.PartiallyConstructible {
...
class BarcodeFormatDataMatrixConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatMaxiCodeConfiguration extends _utils.PartiallyConstructible {
...
*/
exports.BarcodeFormatMaxiCodeConfiguration = BarcodeFormatMaxiCodeConfiguration;
/** @internal */
...
*/
class BarcodeFormatAustraliaPostConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatJapanPostConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatRoyalMailConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatRoyalTntPostConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatUspsIntelligentMailConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatPharmaCodeTwoTrackConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatGs1CompositeConfiguration extends _utils.PartiallyConstructible {
...
class BarcodeFormatCommonOneDConfiguration extends _utils.PartiallyConstructible {
  ...
  /**
    ...
    */
  formats = ['CODABAR', 'CODE_11', 'CODE_25', 'CODE_32', 'CODE_39', 'CODE_93', 'CODE_128', 'DATABAR', 'DATABAR_EXPANDED', 'DATABAR_LIMITED', 'EAN_8', 'EAN_13', 'IATA_2_OF_5', 'INDUSTRIAL_2_OF_5', 'ITF', 'MSI_PLESSEY', 'PHARMA_CODE', 'PZN_7', 'PZN_8', 'UPC_A', 'UPC_E'];
...
class BarcodeFormatCommonTwoDConfiguration extends _utils.PartiallyConstructible {
  ...
  /**
    ...
    */
  formats = ['AZTEC', 'DATA_MATRIX', 'MAXI_CODE', 'MICRO_QR_CODE', 'MICRO_PDF_417', 'PDF_417', 'QR_CODE', 'RMQR_CODE'];
...
class BarcodeFormatCommonFourStateConfiguration extends _utils.PartiallyConstructible {
  ...
  /**
    ...
    */
  formats = ['AUSTRALIA_POST', 'JAPAN_POST', 'ROYAL_MAIL', 'ROYAL_TNT_POST', 'USPS_INTELLIGENT_MAIL'];
...
class BarcodeFormatCommonConfiguration extends _utils.PartiallyConstructible {
...
exports.BarcodeFormatCommonConfiguration = BarcodeFormatCommonConfiguration;
//# sourceMappingURL=BarcodeConfigurationTypes.js.map