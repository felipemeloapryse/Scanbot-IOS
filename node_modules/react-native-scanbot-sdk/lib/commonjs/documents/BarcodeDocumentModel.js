...
const VCardFormattedNameDocumentType = exports.VCardFormattedNameDocumentType = 'FormattedName';
...
const VCardLabelDocumentType = exports.VCardLabelDocumentType = 'Label';
...
const VCardAgentDocumentType = exports.VCardAgentDocumentType = 'Agent';
...
const VCardSortStringDocumentType = exports.VCardSortStringDocumentType = 'SortString';
const VCardClassificationDocumentType = exports.VCardClassificationDocumentType = 'Classification';
...
const HIBCDocumentType = exports.HIBCDocumentType = 'HIBC';
...
class VCard {
  ...
  get languageses() {
    return this.document.children.filter(c => c.type.name === 'Languages').map(c => new VCard.Languages(c));
  }
  ...
  get categorieses() {
    return this.document.children.filter(c => c.type.name === 'Categories').map(c => new VCard.Categories(c));
  }
...
(function (_VCard) {
  ...
  class FormattedName extends Entry {
    ...
    requiredDocumentType() {
      return VCardFormattedNameDocumentType;
    }
  }
  ...
  class SortString extends Entry {
    ...
    requiredDocumentType() {
      return VCardSortStringDocumentType;
    }
  }
  ...
  class Classification extends Entry {
    ...
    requiredDocumentType() {
      return VCardClassificationDocumentType;
    }
  }
