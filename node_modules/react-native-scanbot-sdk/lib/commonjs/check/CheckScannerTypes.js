...
exports.CheckStandardValues = exports.CheckScanningResult = exports.CheckScannerConfiguration = exports.CheckMagneticInkStripScanningStatusValues = exports.CheckDocumentDetectionModeValues = void 0;
...
/// Generated from core/schemas/CheckScannerTypes.yaml
...
const CheckDocumentDetectionModeValues = exports.CheckDocumentDetectionModeValues = ['DISABLED', 'DETECT_DOCUMENT', 'DETECT_AND_CROP_DOCUMENT'];
...
const CheckMagneticInkStripScanningStatusValues = exports.CheckMagneticInkStripScanningStatusValues = ['SUCCESS', 'INCOMPLETE_VALIDATION', 'ERROR_NOTHING_FOUND'];

/**
The result of check scanning.
*/
class CheckScanningResult extends _utils.PartiallyConstructible {
  /**
    Magnetic ink strip scanning status.
    
    Default is ERROR_NOTHING_FOUND
    */
  status = 'ERROR_NOTHING_FOUND';
  /**
  ...
  constructor(source = {}) {
    ...
    if (source.check !== undefined) {
      this.check = source.check != null ? new _GenericDocument.GenericDocument(source.check) : null;
    } else {
...
*/
exports.CheckScanningResult = CheckScanningResult;
const CheckStandardValues = exports.CheckStandardValues = ['USA', 'FRA', 'KWT', 'AUS', 'IND', 'ISR', 'UAE', 'CAN'];

/**
Configuration of the check scanner.
*/
class CheckScannerConfiguration extends _utils.PartiallyConstructible {
  /**
    ...
    Default is DISABLED
    */
  documentDetectionMode = 'DISABLED';
  /**
...
exports.CheckScannerConfiguration = CheckScannerConfiguration;
