...
export declare class DocumentDetectionScores extends PartiallyConstructible {
    ...
    serialize(config?: ToJsonConfiguration): DeepPartial<DocumentDetectionScores>;
}
/**
...
export declare class DocumentDetectionResult extends PartiallyConstructible {
    ...
    serialize(config?: ToJsonConfiguration): DeepPartial<DocumentDetectionResult>;
}
//# sourceMappingURL=DocumentScannerTypes.d.ts.map