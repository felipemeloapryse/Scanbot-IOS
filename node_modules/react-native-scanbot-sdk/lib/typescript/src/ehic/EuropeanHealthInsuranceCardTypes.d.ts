...
export declare class EuropeanHealthInsuranceCardRecognitionResult extends PartiallyConstructible {
    ...
    serialize(config?: ToJsonConfiguration): DeepPartial<EuropeanHealthInsuranceCardRecognitionResult>;
}
export declare namespace EuropeanHealthInsuranceCardRecognitionResult {
    ...
    class Field extends PartiallyConstructible {
        ...
        serialize(config?: ToJsonConfiguration): DeepPartial<Field>;
    }
    namespace Field {
        /**
...
//# sourceMappingURL=EuropeanHealthInsuranceCardTypes.d.ts.map