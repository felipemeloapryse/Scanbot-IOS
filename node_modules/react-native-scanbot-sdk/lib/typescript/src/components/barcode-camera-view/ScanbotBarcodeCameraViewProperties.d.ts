...
import { BarcodeAccumulationConfiguration, BarcodeDocumentFormat, BarcodeFormatConfigurationBase, BarcodeItem, BarcodeScannerEngineMode } from '../../barcode';
...
export interface SelectionOverlayConfig {
    ...
    barcodeItemOverlayViewBinder?: (barcodeItem: BarcodeItem) => Promise<BarcodeItemOverlayViewConfig> | BarcodeItemOverlayViewConfig;
}
