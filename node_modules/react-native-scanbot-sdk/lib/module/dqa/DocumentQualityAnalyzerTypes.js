...
export const DocumentQualityValues = ['VERY_POOR', 'POOR', 'REASONABLE', 'GOOD', 'EXCELLENT'];
...
export class DocumentQualityAnalyzerResult extends PartiallyConstructible {
  ...
  constructor(source = {}) {
    ...
    if (source.qualityHeatmap !== undefined) {
      this.qualityHeatmap = source.qualityHeatmap != null ? ImageRef.From(source.qualityHeatmap) : null;
    }
  }
