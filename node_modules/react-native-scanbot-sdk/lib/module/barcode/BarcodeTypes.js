...
*/
export class StructuredAppendInfo extends PartiallyConstructible {
  /**
...
export const BarcodeFormatValues = ['NONE', 'AZTEC', 'CODABAR', 'CODE_39', 'CODE_93', 'CODE_128', 'DATA_MATRIX', 'EAN_8', 'EAN_13', 'ITF', 'MAXI_CODE', 'PDF_417', 'QR_CODE', 'DATABAR', 'DATABAR_EXPANDED', 'UPC_A', 'UPC_E', 'MSI_PLESSEY', 'IATA_2_OF_5', 'INDUSTRIAL_2_OF_5', 'CODE_25', 'MICRO_QR_CODE', 'USPS_INTELLIGENT_MAIL', 'ROYAL_MAIL', 'JAPAN_POST', 'ROYAL_TNT_POST', 'AUSTRALIA_POST', 'DATABAR_LIMITED', 'MICRO_PDF_417', 'GS1_COMPOSITE', 'RMQR_CODE', 'CODE_11', 'CODE_32', 'PHARMA_CODE', 'PHARMA_CODE_TWO_TRACK', 'PZN_7', 'PZN_8'];

/**
Lists of barcode formats to decode.
*/
export class BarcodeFormats extends PartiallyConstructible {
...
*/
export const Gs1HandlingValues = ['PARSE', 'VALIDATE_STRUCTURE', 'DECODE_STRUCTURE', 'VALIDATE_FULL', 'DECODE_FULL'];
...
export const UpcEanExtensionBehaviorValues = ['REQUIRE_2', 'REQUIRE_5', 'REQUIRE_ANY', 'IGNORE', 'ALLOW_2', 'ALLOW_5', 'ALLOW_ANY'];
