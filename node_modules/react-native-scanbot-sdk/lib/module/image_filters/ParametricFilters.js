...
export const BinarizationFilterPresetValues = ['PRESET_1', 'PRESET_2', 'PRESET_3', 'PRESET_4', 'PRESET_5'];
...
export class GrayscaleFilter extends PartiallyConstructible {
  ...
  serialize(config = new ToJsonConfiguration()) {
    return {
      _type: this._type,
      borderWidthFraction: this.borderWidthFraction,
      blackOutliersFraction: this.blackOutliersFraction,
      whiteOutliersFraction: this.whiteOutliersFraction
    };
  }
}
