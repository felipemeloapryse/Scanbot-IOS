...
export class CnPermanentResidentCardFront {
  get document() {
    return this._document;
  }
  constructor(document) {
  ...
  requiredDocumentType() {
    return CnPermanentResidentCardFrontDocumentType;
  }
...
/** HkIdentityCardFront */
export class HkIdentityCardFront {
  get document() {
    return this._document;
  }
  constructor(document) {
  ...
  requiredDocumentType() {
    return HkIdentityCardFrontDocumentType;
  }
  ...
  get givenNamesInChineseCode() {
    return this.document.fields.find(f => f.type.name === 'GivenNamesInChineseCode');
  }
  ...
  /** ID Symbols */
  get idSymbols() {
    return this.document.fields.find(f => f.type.name === 'IDSymbols');
  }

  /** Date when the cardholder was initially registered */
  get initialRegistrationDate() {
    return this.document.fields.find(f => f.type.name === 'InitialRegistrationDate');
  }
...
export class TwEntryAndExitPermit {
  get document() {
    return this._document;
  }
  constructor(document) {
  ...
  requiredDocumentType() {
    return TwEntryAndExitPermitDocumentType;
  }

  /** Barcode on the left of the document */
  get barcodeLeft() {
    return this.document.fields.find(f => f.type.name === 'BarcodeLeft');
  }

  /** Barcode on the right of the document */
  get barcodeRight() {
    return this.document.fields.find(f => f.type.name === 'BarcodeRight');
  }
  ...
  get countryOfResidency() {
    return this.document.fields.find(f => f.type.name === 'CountryOfResidency');
  }
  ...
  get entryInspection() {
    return this.document.fields.find(f => f.type.name === 'EntryInspection');
  }

  /** Exit inspection information */
  get exitInspection() {
    return this.document.fields.find(f => f.type.name === 'ExitInspection');
  }
  ...
  /** Passport Number */
  get passportNumber() {
    return this.document.fields.find(f => f.type.name === 'PassportNumber');
  }
...
/** MoIdentityCardBack */
export class MoIdentityCardBack {
  get document() {
    return this._document;
  }
  constructor(document) {
  ...
  requiredDocumentType() {
    return MoIdentityCardBackDocumentType;
  }
  ...
  /** Validation Photo */
  get validationPhoto() {
    return this.document.fields.find(f => f.type.name === 'ValidationPhoto');
  }
...
/** MoIdentityCardFront */
export class MoIdentityCardFront {
  get document() {
    return this._document;
  }
  constructor(document) {
  ...
  requiredDocumentType() {
    return MoIdentityCardFrontDocumentType;
  }
