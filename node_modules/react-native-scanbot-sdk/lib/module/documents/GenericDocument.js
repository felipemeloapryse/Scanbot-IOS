...
import { CommonFieldTypeValues } from '../documents/CommonFieldType';
...
export const FieldValidationStatusValues = ['INVALID', 'OBSTRUCTED', 'NONE', 'CONFIRMED', 'INFERRED', 'VALID', 'IGNORED'];
...
export const FieldDataFormatValues = ['ISO_DATE', 'ISO_COUNTRY_ALPHA_2', 'ISO_COUNTRY_ALPHA_3', 'ISO_COUNTRY_NUMERIC', 'ISO_COUNTRY_NAME', 'GENDER'];
...
export class FieldType extends PartiallyConstructible {
  ...
  constructor(source = {}) {
    ...
    if (source.commonType !== undefined) {
      this.commonType = source.commonType != null ? CommonFieldTypeValues.includes(source.commonType) ? source.commonType : null : null;
    } else {
