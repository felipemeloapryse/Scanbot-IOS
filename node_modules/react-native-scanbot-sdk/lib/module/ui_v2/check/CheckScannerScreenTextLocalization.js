...
export class CheckScannerScreenTextLocalization extends PartiallyConstructible {
  ...
  /**
    ...
    */
  introScreenText = "This scanner reads the MICR (Magnetic Ink Character Recognition) line – the numbers and characters printed at the bottom of your check.\n\nTo scan, place the check on a flat, well-lit surface and position your camera so the entire check is within the frame. The check data will be automatically extracted.\nTap 'Start Scanning' to begin.";
  /**
  ...
  /**
    ...
    */
  checkImageNotGoodAlertTitle = 'Check not recognized';
  /**
  ...
  /**
    ...
    Default is "Looking for check..."
    */
  checkUserGuidanceNoCheckFound = 'Looking for check...';
  /**
    The user guidance text displayed when a check presence was detected.
    
    Default is "Scanning the check..."
    */
  checkUserGuidanceScanningProgress = 'Scanning the check...';
  /**
    ...
    */
  checkUserGuidanceTooDark = 'Too dark. Please turn on a light.';
  /**
    ...
    */
  checkUserGuidanceTooSmall = 'Please move closer to the check.';
  /**
    ...
    */
  checkUserGuidanceBadPerspective = 'Please hold your device straight over the check.';
...
//# sourceMappingURL=CheckScannerScreenTextLocalization.js.map