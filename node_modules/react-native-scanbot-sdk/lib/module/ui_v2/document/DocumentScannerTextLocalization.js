...
/// Generated from rtu-ui-v2/schemas/document/DocumentScannerTextLocalization.yaml
...
*/
export class DocumentScannerTextLocalization extends PartiallyConstructible {
  /**
  ...
  /**
    ...
    Default is "Orientation mismatch"
    */
  cameraUserGuidanceOrientationMismatch = 'Orientation mismatch';
  /**
  ...
  constructor(source = {}) {
    ...
    if (source.cameraUserGuidanceOrientationMismatch !== undefined) {
      this.cameraUserGuidanceOrientationMismatch = source.cameraUserGuidanceOrientationMismatch;
    }
