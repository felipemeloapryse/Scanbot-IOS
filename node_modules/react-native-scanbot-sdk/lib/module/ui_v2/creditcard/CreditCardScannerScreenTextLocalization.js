...
export class CreditCardScannerScreenTextLocalization extends PartiallyConstructible {
  /**
    ...
    */
  topBarTitle = 'Credit Card Scanner';
  /**
  ...
  /**
    ...
    */
  topUserGuidance = 'Scan the credit card';
  /**
    Title for the introduction screen.
    
    Default is "How to scan a credit card"
    */
  introScreenTitle = 'How to scan a credit card';
  /**
  ...
  /**
    ...
    */
  introScreenText = "To quickly and securely input your credit card details, please hold your device over the credit card, so that the camera aligns with the numbers on the front of the card. \n\nThe scanner will guide you to the optimal scanning position. Once the scan is complete, your card details will automatically be extracted and processed.\n\nPress 'Start Scanning' to begin.";
  /**
  ...
  /**
    ...
    */
  completionOverlayIncompleteDataMessage = 'Incomplete scan';
  /**
  ...
  /**
    ...
    */
  creditCardUserGuidanceNoCardFound = 'Looking for credit card...';
  /**
    The user guidance text displayed when a card presence was detected.
    
    Default is "Scanning the credit card..."
    */
  creditCardUserGuidanceScanningProgress = 'Scanning the credit card...';
  /**
    ...
    */
  creditCardUserGuidanceTooDark = 'Too dark. Please turn on a light.';
  /**
    ...
    */
  creditCardUserGuidanceTooSmall = 'Please move closer to the credit card.';
  /**
    ...
    */
  creditCardUserGuidanceBadPerspective = 'Please hold your device straight over the credit card.';
  /**
...
//# sourceMappingURL=CreditCardScannerScreenTextLocalization.js.map