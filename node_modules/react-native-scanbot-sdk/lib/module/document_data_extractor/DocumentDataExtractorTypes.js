...
import { DocumentDataExtractorCommonConfiguration, DocumentDataExtractorConfigurationElement } from '../document_data_extractor/DocumentDataExtractorConfigurationTypes';
...
export const DocumentDataExtractionStatusValues = ['SUCCESS', 'ERROR_NOTHING_FOUND', 'ERROR_BAD_CROP', 'ERROR_UNKNOWN_DOCUMENT', 'ERROR_UNACCEPTABLE_DOCUMENT', 'ERROR_STILL_FOCUSSING', 'INCOMPLETE_VALIDATION'];
...
export class DocumentDataExtractionResult extends PartiallyConstructible {
  ...
  async serialize(config = new ToJsonConfiguration()) {
    return {
      ...
      croppedImage: config.serializeImages ? this.croppedImage != null ? await this.croppedImage.serialize(config.imageSerializationMode) : null : undefined
    };
  }
  _released = false;
  release() {
...
export const DocumentDataExtractionModeValues = ['LIVE', 'SINGLE_SHOT'];
...
export const DocumentTrustModeValues = ['TRUSTED', 'UNTRUSTED'];
...
export class DocumentDataExtractorConfiguration extends PartiallyConstructible {
  ...
  /**
    ...
    */
  configurations = [new DocumentDataExtractorCommonConfiguration({})];
  /**
  ...
  constructor(source = {}) {
    ...
    if (source.fieldExcludeList !== undefined) {
      this.fieldExcludeList = source.fieldExcludeList.map(it => {
        return it;
      });
    }
    if (source.configurations !== undefined) {
      this.configurations = source.configurations.map(it => {
...
export const ValueConsistencyValues = ['OK', 'OK_PUNCTUATION_UPPER_CASE_CLEANED', 'OK_DEBURRED', 'OK_DEBURRED_EXTENDED', 'OK_TRUNCATED', 'INCONSISTENT'];
...
export class FieldConsistencyVerificationReport extends PartiallyConstructible {
  ...
  constructor(source = {}) {
    ...
    if (source.fieldFullNames !== undefined) {
      this.fieldFullNames = source.fieldFullNames.map(it => {
        return it;
      });
    } else {
  ...
  serialize(config = new ToJsonConfiguration()) {
    return {
      ...
      fieldFullNames: this.fieldFullNames.map(it => {
        return it;
      })
    };
  }
...
export class ConsistencyVerificationReport extends PartiallyConstructible {
  ...
  constructor(source = {}) {
    ...
    if (source.fieldDetails !== undefined) {
      this.fieldDetails = source.fieldDetails.map(it => {
  ...
  serialize(config = new ToJsonConfiguration()) {
    return {
      ...
      fieldDetails: this.fieldDetails.map(it => {
...
export const ValueSemanticsValues = ['SKIPPED', 'VALID', 'INVALID'];
...
export const DocumentVerificationStatusValues = ['OK', 'OK_WITH_WARNINGS', 'INVALID'];
...
export class DocumentVerificationReport extends PartiallyConstructible {
  ...
  constructor(source = {}) {
    ...
    if (source.consistencyVerificationReport !== undefined) {
      this.consistencyVerificationReport = new ConsistencyVerificationReport(source.consistencyVerificationReport);
    } else {
    ...
    if (source.semanticsVerificationReport !== undefined) {
      this.semanticsVerificationReport = new SemanticsVerificationReport(source.semanticsVerificationReport);
    } else {
    ...
    if (source.suspiciousDataVerificationReport !== undefined) {
      this.suspiciousDataVerificationReport = new SuspiciousDataVerificationReport(source.suspiciousDataVerificationReport);
    } else {
    ...
    if (source.invalidDataVerificationReport !== undefined) {
      this.invalidDataVerificationReport = new InvalidDataVerificationReport(source.invalidDataVerificationReport);
    } else {
...
//# sourceMappingURL=DocumentDataExtractorTypes.js.map