...
import { CameraModule, CameraPreviewMode, CapturePhotoQualityPrioritization } from '../../base';
import { DocumentDetectionStatus } from '../../document_scanner';
import { CameraViewAspectRatio } from '../CameraViewTypes';

export interface ScanbotDocumentScannerViewProperties {
  style?: StyleProp<ViewStyle>;
  /**
   Detected document image as a base64 result
   */
...
export interface ScanbotDocumentScannerViewHandle {
  ...
  /**
   *  Snaps a document.
   *  If `acquireFocus` is true, the document will be focused after snapping. Android only
   */
  snapDocument(acquireFocus?: boolean): void;
}
