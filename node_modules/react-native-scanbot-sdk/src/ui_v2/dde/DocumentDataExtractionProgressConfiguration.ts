...
/// Generated from rtu-ui-v2/schemas/documentdataextractor/DocumentDataExtractionProgressConfiguration.yaml
...
*/
export class DocumentDataExtractionProgressConfiguration extends PartiallyConstructible {
  /**
  ...
  /** @param source {@displayType `DeepPartial<DocumentDataExtractionProgressConfiguration>`} */
  public constructor(source: DeepPartial<DocumentDataExtractionProgressConfiguration> = {}) {
    super();
