...
/// Generated from rtu-ui-v2/schemas/creditcard/CreditCardScannerScreenConfiguration.yaml
...
*/
export class CreditCardScannerScreenConfiguration extends PartiallyConstructible {
  /**
  ...
  /**
    ...
    */
  public readonly screen: string = 'CreditCardScanner';
  /**
    Configuration of the all strings for credit card scanner screen.
    */
  public localization: CreditCardScannerScreenTextLocalization =
    new CreditCardScannerScreenTextLocalization({});
  /**
  ...
  /**
    ...
    */
  public scanStatusUserGuidance: CreditCardScanGuidanceConfiguration =
    new CreditCardScanGuidanceConfiguration({});
  /**
  ...
  /**
    ...
    */
  public introScreen: CreditCardScannerIntroScreenConfiguration =
    new CreditCardScannerIntroScreenConfiguration({});
  /**
  ...
  public viewFinder: PermanentViewFinderConfiguration = new PermanentViewFinderConfiguration({
    ...
    aspectRatio: new AspectRatio({ width: 1.586, height: 1.0 }),
    minimumInsets: new EdgeInsets({ top: 24.0, left: 24.0, bottom: 24.0, right: 24.0 }),
  });
  /**
    Configuration for the credit card recognizer.
    */
  public scannerConfiguration: CreditCardScannerConfiguration = new CreditCardScannerConfiguration(
    {}
  );
  /**
    ...
    Default is true
    */
  public exampleOverlayVisible: boolean = true;
  /**
    Configuration of visualization of the scanning progress.
    */
  public scanningProgress: CreditCardScanningProgressConfiguration =
    new CreditCardScanningProgressConfiguration({});
  /**
    Timeout for the scan process. If the scan process takes longer than this value, the incomplete result will be returned.
    
    Default is 3000
    */
  public scanIncompleteDataTimeout: number = 3000;
  /**
  ...
  /**
    Configuration of the success overlay.
    */
  public incompleteDataOverlay: ScanCompletionOverlay = new ScanCompletionOverlay({
    message: new StyledText({ text: '?completionOverlayIncompleteDataMessage' }),
  });
  /**
  ...
  public constructor(source: DeepPartial<CreditCardScannerScreenConfiguration> = {}) {
    super();
    ...
    if (source.localization !== undefined) {
      this.localization = new CreditCardScannerScreenTextLocalization(source.localization);
    }
    ...
    if (source.scanStatusUserGuidance !== undefined) {
      this.scanStatusUserGuidance = new CreditCardScanGuidanceConfiguration(
        source.scanStatusUserGuidance
      );
    }
    ...
    if (source.introScreen !== undefined) {
      this.introScreen = new CreditCardScannerIntroScreenConfiguration(source.introScreen);
    }
    ...
    if (source.scannerConfiguration !== undefined) {
      this.scannerConfiguration = new CreditCardScannerConfiguration(source.scannerConfiguration);
    }
    ...
    if (source.scanningProgress !== undefined) {
      this.scanningProgress = new CreditCardScanningProgressConfiguration(source.scanningProgress);
    }
    if (source.scanIncompleteDataTimeout !== undefined) {
      this.scanIncompleteDataTimeout = source.scanIncompleteDataTimeout;
    }
    if (source.successOverlay !== undefined) {
      this.successOverlay = new ScanCompletionOverlay(source.successOverlay);
    }
    if (source.incompleteDataOverlay !== undefined) {
      this.incompleteDataOverlay = new ScanCompletionOverlay(source.incompleteDataOverlay);
    }
