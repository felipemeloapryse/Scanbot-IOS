...
export const OrientationLockModeValues: OrientationLockMode[] = ['NONE', 'PORTRAIT', 'LANDSCAPE'];
...
export const CameraPreviewModeValues: CameraPreviewMode[] = ['FIT_IN', 'FILL_IN'];
...
export const SoundTypeValues: SoundType[] = ['MODERN_BEEP', 'CLASSIC_BEEP'];
...
*/
export class EdgeInsets extends PartiallyConstructible {
  /**
    The top inset.
