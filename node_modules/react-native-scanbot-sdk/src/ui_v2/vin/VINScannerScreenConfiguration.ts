...
/// Generated from rtu-ui-v2/schemas/vin/VINScannerScreenConfiguration.yaml
...
import { VinScannerIntroScreenConfiguration } from '../../ui_v2/vin/VINScannerIntroScreenConfiguration';
import { VinScannerScreenTextLocalization } from '../../ui_v2/vin/VINScannerScreenTextLocalization';
import { AspectRatio } from '../../utils/geometry/Geometry';
import { DeepPartial, PartiallyConstructible } from '../../utils/utils';
import { VinScannerConfiguration } from '../../vin/VinScannerTypes';

/**
Configuration of the screen for detecting VIN data.
*/
export class VinScannerScreenConfiguration extends PartiallyConstructible {
  /**
  ...
  /**
    ...
    Default is "VINScanner"
    */
  public readonly screen: string = 'VINScanner';
  /**
    Configuration of the all strings for VIN scanner screen.
    */
  public localization: VinScannerScreenTextLocalization = new VinScannerScreenTextLocalization({});
  /**
  ...
  /**
    ...
    */
  public introScreen: VinScannerIntroScreenConfiguration = new VinScannerIntroScreenConfiguration(
    {}
  );
  /**
  ...
  public viewFinder: PermanentViewFinderConfiguration = new PermanentViewFinderConfiguration({
    ...
    aspectRatio: new AspectRatio({ width: 5.0, height: 1.0 }),
    preferredHeight: 56.0,
  });
  /**
    Configuration of the scanner.
    */
  public scannerConfiguration: VinScannerConfiguration = new VinScannerConfiguration({});
  /**
  ...
  public confirmationAlertDialog: ScanbotAlertDialog = new ScanbotAlertDialog({
    title: new StyledText({ text: '?vinConfirmationAlertTitle', color: '?sbColorOnSurface' }),
  ...
  /** @param source {@displayType `DeepPartial<VinScannerScreenConfiguration>`} */
  public constructor(source: DeepPartial<VinScannerScreenConfiguration> = {}) {
    super();
    ...
    if (source.localization !== undefined) {
      this.localization = new VinScannerScreenTextLocalization(source.localization);
    }
    ...
    if (source.introScreen !== undefined) {
      this.introScreen = new VinScannerIntroScreenConfiguration(source.introScreen);
    }
    ...
    if (source.scannerConfiguration !== undefined) {
      this.scannerConfiguration = new VinScannerConfiguration(source.scannerConfiguration);
    }
