...
export const MultipleBarcodesScanningModeValues: MultipleBarcodesScanningMode[] = [
  'COUNTING',
  'UNIQUE',
];
...
export const SheetModeValues: SheetMode[] = ['BUTTON', 'COLLAPSED_SHEET'];
...
export const CollapsedVisibleHeightValues: CollapsedVisibleHeight[] = ['SMALL', 'LARGE'];
