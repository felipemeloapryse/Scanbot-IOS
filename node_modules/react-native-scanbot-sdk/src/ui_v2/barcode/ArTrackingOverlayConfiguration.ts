...
import { BackgroundStyle, BadgeStyle, PolygonStyle, StyledText } from '../../ui_v2/common/Common';
...
export const BarcodeItemInfoPositionValues: BarcodeItemInfoPosition[] = [
  'DISABLED',
  'STACKED',
  'BELOW',
  'ABOVE',
...
export class ArOverlayGeneralConfiguration extends PartiallyConstructible {
  ...
  /**
    ...
    Default is DISABLED
    */
  public barcodeItemInfoPosition: BarcodeItemInfoPosition = 'DISABLED';
  /**
    Configuration of the overlay polygon displayed on top of a barcode in the camera preview.
    */
