...
/// Generated from rtu-ui-v2/schemas/mrz/MRZScannerScreenConfiguration.yaml

import { MrzScannerConfiguration } from '../../mrz/MrzTypes';
...
} from '../../ui_v2/mrz/MRZFinderLayoutPreset';
import { MrzScannerIntroScreenConfiguration } from '../../ui_v2/mrz/MRZScannerIntroScreenConfiguration';
import { MrzScannerScreenTextLocalization } from '../../ui_v2/mrz/MRZScannerScreenTextLocalization';
...
*/
export class MrzScannerScreenConfiguration extends PartiallyConstructible {
  /**
  ...
  /**
    ...
    */
  public readonly screen: string = 'MrzScanner';
  /**
    Configuration of the all strings for MRZ scanner screen.
    */
  public localization: MrzScannerScreenTextLocalization = new MrzScannerScreenTextLocalization({});
  /**
  ...
  /**
    ...
    */
  public introScreen: MrzScannerIntroScreenConfiguration = new MrzScannerIntroScreenConfiguration(
    {}
  );
  /**
  ...
  /**
    ...
    */
  public scannerConfiguration: MrzScannerConfiguration = new MrzScannerConfiguration({});
  /**
    Configuration of the overlay text inside finder.
    */
  public mrzExampleOverlay: MrzFinderLayoutPreset = new TwoLineMrzFinderLayoutPreset({});
  /**
  ...
  public constructor(source: DeepPartial<MrzScannerScreenConfiguration> = {}) {
    super();
    ...
    if (source.localization !== undefined) {
      this.localization = new MrzScannerScreenTextLocalization(source.localization);
    }
    ...
    if (source.introScreen !== undefined) {
      this.introScreen = new MrzScannerIntroScreenConfiguration(source.introScreen);
    }
    ...
    if (source.scannerConfiguration !== undefined) {
      this.scannerConfiguration = new MrzScannerConfiguration(source.scannerConfiguration);
    }
    if (source.mrzExampleOverlay !== undefined) {
      this.mrzExampleOverlay = MrzFinderLayoutPreset.From(source.mrzExampleOverlay);
    }
