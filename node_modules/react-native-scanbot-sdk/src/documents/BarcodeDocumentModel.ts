...
export class BoardingPass {
  ...
  /** Electronic Ticket */
  get electronicTicketIndicator(): Field {
    return this.document.fields.find(
      (f: Field) => f.type.name === 'ElectronicTicketIndicator'
    ) as Field;
  }

  /** Format Code. */
  get formatCode(): Field {
    return this.document.fields.find((f: Field) => f.type.name === 'FormatCode') as Field;
  }
  ...
  get passengerName(): Field {
    return this.document.fields.find((f: Field) => f.type.name === 'PassengerName') as Field;
  }

  /** Security Data */
  get securityData(): Field | undefined {
    return this.document.fields.find((f: Field) => f.type.name === 'SecurityData');
  }

  /** Security Data Type */
  get securityDataType(): Field | undefined {
    return this.document.fields.find((f: Field) => f.type.name === 'SecurityDataType');
  }
...
export class SwissQR {
  ...
  get majorVersion(): Field {
    return this.document.fields.find((f: Field) => f.type.name === 'MajorVersion') as Field;
  }
...
export class VCard {
  ...
  get sources(): VCard.Source[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Source')
      .map((c: GenericDocument) => new VCard.Source(c));
  }
  ...
  get xmls(): VCard.XML[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'XML')
      .map((c: GenericDocument) => new VCard.XML(c));
  }
  ...
  get formattedName(): VCard.FormattedName | undefined {
    const child = this.document.children.find(
      (c: GenericDocument) => c.type.name === 'FormattedName'
    );
  ...
  get nicknames(): VCard.Nickname[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Nickname')
      .map((c: GenericDocument) => new VCard.Nickname(c));
  }
  ...
  get deliveryAddresses(): VCard.DeliveryAddress[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'DeliveryAddress')
      .map((c: GenericDocument) => new VCard.DeliveryAddress(c));
  }

  /** An array of all children of type "Label". */
  get labels(): VCard.Label[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Label')
      .map((c: GenericDocument) => new VCard.Label(c));
  }

  /** An array of all children of type "Photo". */
  get photos(): VCard.Photo[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Photo')
      .map((c: GenericDocument) => new VCard.Photo(c));
  }

  /** An array of all children of type "TelephoneNumber". */
  get telephoneNumbers(): VCard.TelephoneNumber[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'TelephoneNumber')
      .map((c: GenericDocument) => new VCard.TelephoneNumber(c));
  }

  /** An array of all children of type "Email". */
  get emails(): VCard.Email[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Email')
      .map((c: GenericDocument) => new VCard.Email(c));
  }

  /** An array of all children of type "IMPP". */
  get impps(): VCard.IMPP[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'IMPP')
  ...
  get languageses(): VCard.Languages[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Languages')
      .map((c: GenericDocument) => new VCard.Languages(c));
  }

  /** An array of all children of type "TimeZone". */
  get timeZones(): VCard.TimeZone[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'TimeZone')
      .map((c: GenericDocument) => new VCard.TimeZone(c));
  }

  /** An array of all children of type "GeoLocation". */
  get geoLocations(): VCard.GeoLocation[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'GeoLocation')
      .map((c: GenericDocument) => new VCard.GeoLocation(c));
  }

  /** An array of all children of type "Title". */
  get titles(): VCard.Title[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Title')
      .map((c: GenericDocument) => new VCard.Title(c));
  }

  /** An array of all children of type "Role". */
  get roles(): VCard.Role[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Role')
      .map((c: GenericDocument) => new VCard.Role(c));
  }

  /** An array of all children of type "Logo". */
  get logos(): VCard.Logo[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Logo')
      .map((c: GenericDocument) => new VCard.Logo(c));
  }

  /** An array of all children of type "Agent". */
  get agents(): VCard.Agent[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Agent')
      .map((c: GenericDocument) => new VCard.Agent(c));
  }

  /** An array of all children of type "Organisation". */
  get organisations(): VCard.Organisation[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Organisation')
      .map((c: GenericDocument) => new VCard.Organisation(c));
  }

  /** An array of all children of type "Member". */
  get members(): VCard.Member[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Member')
      .map((c: GenericDocument) => new VCard.Member(c));
  }

  /** An array of all children of type "Related". */
  get relateds(): VCard.Related[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Related')
  ...
  get categorieses(): VCard.Categories[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Categories')
      .map((c: GenericDocument) => new VCard.Categories(c));
  }

  /** An array of all children of type "Note". */
  get notes(): VCard.Note[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Note')
      .map((c: GenericDocument) => new VCard.Note(c));
  }
  ...
  get sounds(): VCard.Sound[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'Sound')
      .map((c: GenericDocument) => new VCard.Sound(c));
  }
  ...
  get clientPIDMaps(): VCard.ClientPIDMap[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'ClientPIDMap')
      .map((c: GenericDocument) => new VCard.ClientPIDMap(c));
  }

  /** An array of all children of type "URL". */
  get urls(): VCard.URL[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'URL')
      .map((c: GenericDocument) => new VCard.URL(c));
  }

  /** An array of all children of type "PublicKey". */
  get publicKeys(): VCard.PublicKey[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'PublicKey')
      .map((c: GenericDocument) => new VCard.PublicKey(c));
  }
  ...
  get calendarURIForRequestss(): VCard.CalendarURIForRequests[] {
    return this.document.children
      .filter((c: GenericDocument) => c.type.name === 'CalendarURIForRequests')
      .map((c: GenericDocument) => new VCard.CalendarURIForRequests(c));
  }
  ...
  get sortString(): VCard.SortString | undefined {
    const child = this.document.children.find((c: GenericDocument) => c.type.name === 'SortString');
  ...
  get classification(): VCard.Classification | undefined {
    const child = this.document.children.find(
      (c: GenericDocument) => c.type.name === 'Classification'
    );
...
export class HIBC {
  ...
  get dateOfManufacture(): Field | undefined {
    return this.document.fields.find((f: Field) => f.type.name === 'DateOfManufacture');
  }

  /** Expiry Date Day */
  get expiryDateDay(): Field | undefined {
    return this.document.fields.find((f: Field) => f.type.name === 'ExpiryDateDay');
  }

  /** Expiry Date Hour */
  get expiryDateHour(): Field | undefined {
    return this.document.fields.find((f: Field) => f.type.name === 'ExpiryDateHour');
  }

  /** Expiry Date Julian Day */
  get expiryDateJulianDay(): Field | undefined {
    return this.document.fields.find((f: Field) => f.type.name === 'ExpiryDateJulianDay');
  }

  /** Expiry Date Month */
  get expiryDateMonth(): Field | undefined {
    return this.document.fields.find((f: Field) => f.type.name === 'ExpiryDateMonth');
  }

  /** Expiry Date Year */
  get expiryDateYear(): Field | undefined {
    return this.document.fields.find((f: Field) => f.type.name === 'ExpiryDateYear');
  }

  /** Information whether primary data is present. */
  get hasPrimaryData(): Field {
    return this.document.fields.find((f: Field) => f.type.name === 'HasPrimaryData') as Field;
  }

  /** Information whether secondary data is present. */
  get hasSecondaryData(): Field {
    return this.document.fields.find((f: Field) => f.type.name === 'HasSecondaryData') as Field;
  }

  /** Labeler Identification Code (LIC) */
  get labelerIdentificationCode(): Field {
    return this.document.fields.find(
      (f: Field) => f.type.name === 'LabelerIdentificationCode'
    ) as Field;
  }
  ...
  get labelersProductOrCatalogNumber(): Field {
    return this.document.fields.find(
      (f: Field) => f.type.name === 'LabelersProductOrCatalogNumber'
    ) as Field;
  }

  /** Link character to link standalone primary and secondary barcodes together. */
  get linkCharacter(): Field | undefined {
    return this.document.fields.find((f: Field) => f.type.name === 'LinkCharacter');
  }

  /** Lot Number */
  get lotNumber(): Field | undefined {
    return this.document.fields.find((f: Field) => f.type.name === 'LotNumber');
  }

  /** Quantity */
  get quantity(): Field | undefined {
    return this.document.fields.find((f: Field) => f.type.name === 'Quantity');
  }
