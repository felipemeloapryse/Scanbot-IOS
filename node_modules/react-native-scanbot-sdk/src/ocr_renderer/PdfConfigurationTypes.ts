...
export class PdfAttributes extends PartiallyConstructible {
  /**
    ...
    */
  public author: string = 'Created with Scanbot SDK';
  /**
    Creator.
  ...
  public constructor(source: DeepPartial<PdfAttributes> = {}) {
    super();
...
export const PageSizeValues: PageSize[] = [
  'LETTER',
  'LEGAL',
  'A3',
  'A4',
...
export const PageDirectionValues: PageDirection[] = ['PORTRAIT', 'LANDSCAPE', 'AUTO'];
...
export const PageFitValues: PageFit[] = ['FIT_IN', 'FILL_IN', 'STRETCH', 'NONE'];
...
export const ResamplingMethodValues: ResamplingMethod[] = [
  'NONE',
  'NEAREST',
  'LINEAR',
  'CUBIC',
...
export class PdfConfiguration extends PartiallyConstructible {
  /**
    Attributes.
    */
  public attributes: PdfAttributes = new PdfAttributes({});
  /**
  ...
  /**
    ...
    Default is PORTRAIT
    */
  public pageDirection: PageDirection = 'PORTRAIT';
  /**
  ...
  /**
    ...
    Default is NONE
    */
  public resamplingMethod: ResamplingMethod = 'NONE';

  /** @param source {@displayType `DeepPartial<PdfConfiguration>`} */
  public constructor(source: DeepPartial<PdfConfiguration> = {}) {
    super();
