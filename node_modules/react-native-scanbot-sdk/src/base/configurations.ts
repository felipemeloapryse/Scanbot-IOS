import { CheckStandard } from '../check/CheckScannerTypes';
import { DocumentScannerEngineMode } from '../document_scanner';
...
export interface CheckScannerScreenConfiguration {
...
export interface DocumentScannerScreenConfiguration {
  ...
  /** The mode of the document scanner to be used for document outline detection. Defaults to ML. iOS only. For Android, use the Scanbot SDK initializer. */
...
export interface HealthInsuranceCardScannerConfiguration {
  ...
  recognizerParameters?: HealthInsuranceCardRecognizerParameters;
}
...
export interface VinScannerScreenConfiguration {
  /** The preferred camera module (default - BACK) */
  cameraModule?: CameraModule;
