...
export const CharacterEncodingValues: CharacterEncoding[] = [
  'UNKNOWN',
  'ASCII',
  'ISO_8859_PART1',
  'ISO_8859_PART2',
...
export class RangeEncoding extends PartiallyConstructible {
  ...
  /**
    ...
    */
  public readonly encoding: CharacterEncoding;
...
export class StructuredAppendInfo extends PartiallyConstructible {
  ...
  public serialize(
    config: ToJsonConfiguration = new ToJsonConfiguration()
  ): DeepPartial<StructuredAppendInfo> {
    return {
      count: this.count,
      index: this.index,
      id: this.id,
...
export const BarcodeFormatValues: BarcodeFormat[] = [
  'NONE',
  'AZTEC',
  'CODABAR',
  'CODE_39',
...
export class BarcodeFormats extends PartiallyConstructible {
  ...
  public serialize(
    config: ToJsonConfiguration = new ToJsonConfiguration()
  ): DeepPartial<BarcodeFormats> {
    return {};
  }
}

export namespace BarcodeFormats {
  /**
    List of 1D barcode formats.
    */
  export const oned: BarcodeFormat[] = [
    'CODABAR',
    'CODE_11',
    'CODE_25',
    'CODE_32',
  ...
  /**
    ...
    */
  export const twod: BarcodeFormat[] = [
    'AZTEC',
    'DATA_MATRIX',
    'MAXI_CODE',
    'MICRO_QR_CODE',
  ...
  /**
    ...
    */
  export const postal: BarcodeFormat[] = [
    'AUSTRALIA_POST',
    'JAPAN_POST',
    'ROYAL_MAIL',
    'ROYAL_TNT_POST',
  ...
  /**
    ...
    */
  export const pharma: BarcodeFormat[] = [
    'CODE_32',
    'PHARMA_CODE',
    'PHARMA_CODE_TWO_TRACK',
    'PZN_7',
  ...
  /**
    ...
    */
  export const common: BarcodeFormat[] = [
    'AZTEC',
    'CODABAR',
    'CODE_39',
    'CODE_93',
  ...
  /**
    ...
    */
  export const all: BarcodeFormat[] = [
    'AUSTRALIA_POST',
    'AZTEC',
    'CODABAR',
    'CODE_11',
...
export const Gs1HandlingValues: Gs1Handling[] = [
  'PARSE',
  'VALIDATE_STRUCTURE',
  'DECODE_STRUCTURE',
  'VALIDATE_FULL',
...
export const UpcEanExtensionBehaviorValues: UpcEanExtensionBehavior[] = [
  'REQUIRE_2',
  'REQUIRE_5',
  'REQUIRE_ANY',
  'IGNORE',
