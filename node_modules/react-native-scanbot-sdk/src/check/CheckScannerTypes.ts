...
export const CheckDocumentDetectionModeValues: CheckDocumentDetectionMode[] = [
  'DISABLED',
  'DETECT_DOCUMENT',
  'DETECT_AND_CROP_DOCUMENT',
];
...
export const CheckMagneticInkStripScanningStatusValues: CheckMagneticInkStripScanningStatus[] = [
  'SUCCESS',
  'INCOMPLETE_VALIDATION',
  'ERROR_NOTHING_FOUND',
];
...
*/
export class CheckScanningResult extends PartiallyConstructible {
  /**
    Magnetic ink strip scanning status.
    
    Default is ERROR_NOTHING_FOUND
    */
  public readonly status: CheckMagneticInkStripScanningStatus = 'ERROR_NOTHING_FOUND';
  /**
  ...
  public constructor(source: DeepPartial<CheckScanningResult> = {}) {
    super();
  ...
  ): Promise<DeepPartial<CheckScanningResult>> {
    return {
      status: this.status,
...
*/
export type CheckStandard = 'USA' | 'FRA' | 'KWT' | 'AUS' | 'IND' | 'ISR' | 'UAE' | 'CAN';

export const CheckStandardValues: CheckStandard[] = [
  'USA',
  'FRA',
  'KWT',
  'AUS',
...
export class CheckScannerConfiguration extends PartiallyConstructible {
  /**
    ...
    Default is DISABLED
    */
  public documentDetectionMode: CheckDocumentDetectionMode = 'DISABLED';
  /**
    ...
    */
  public acceptedCheckStandards: CheckStandard[] = [];

  /** @param source {@displayType `DeepPartial<CheckScannerConfiguration>`} */
  public constructor(source: DeepPartial<CheckScannerConfiguration> = {}) {
    super();
    ...
    if (source.acceptedCheckStandards !== undefined) {
      this.acceptedCheckStandards = source.acceptedCheckStandards.map((it: any) => {
        return it;
      });
    }
  }
  ...
  public serialize(
    config: ToJsonConfiguration = new ToJsonConfiguration()
  ): DeepPartial<CheckScannerConfiguration> {
    return {
      documentDetectionMode: this.documentDetectionMode,
      acceptedCheckStandards: this.acceptedCheckStandards.map((it: any) => {
        return it;
      }),
    };
  }
