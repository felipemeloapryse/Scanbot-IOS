...
/** @internal */
export namespace DocumentDataExtractorConfigurationElement {
  /** @internal */
  export function From(source: { [key: string]: any }): DocumentDataExtractorConfigurationElement {
...
*/
export class DateValidationConfiguration extends PartiallyConstructible {
  public readonly _type: 'DateValidationConfiguration' = 'DateValidationConfiguration';
  /**
  ...
  public constructor(source: DeepPartial<DateValidationConfiguration> = {}) {
    super();
...
*/
export class DeAddressParserConfiguration extends PartiallyConstructible {
  public readonly _type: 'DeAddressParserConfiguration' = 'DeAddressParserConfiguration';
  /**
  ...
  /**
    ...
    Default is ""
    */
  public binaryFileAddressDatabase: string = '';

  /** @param source {@displayType `DeepPartial<DeAddressParserConfiguration>`} */
  public constructor(source: DeepPartial<DeAddressParserConfiguration> = {}) {
    super();
    if (source.documentTypes !== undefined) {
      this.documentTypes = source.documentTypes.map((it: any) => {
        return it;
      });
    } else {
...
- `SWITZERLAND`:
   Switzerland.
*/
export type EuropeanHealthInsuranceCardIssuingCountry =
  | 'AUSTRIA'
  | 'BELGIUM'
  | 'BULGARIA'
  | 'CROATIA'
...
export const EuropeanHealthInsuranceCardIssuingCountryValues: EuropeanHealthInsuranceCardIssuingCountry[] =
  [
    'AUSTRIA',
    'BELGIUM',
    'BULGARIA',
...
*/
export class EuropeanHealthInsuranceCardConfiguration extends PartiallyConstructible {
  public readonly _type: 'EuropeanHealthInsuranceCardConfiguration' =
    'EuropeanHealthInsuranceCardConfiguration';
  /**
    ...
    */
  public expectedCountry: EuropeanHealthInsuranceCardIssuingCountry | null = null;

  /** @param source {@displayType `DeepPartial<EuropeanHealthInsuranceCardConfiguration>`} */
  public constructor(source: DeepPartial<EuropeanHealthInsuranceCardConfiguration> = {}) {
    super();
    if (source.expectedCountry !== undefined) {
      this.expectedCountry =
        source.expectedCountry != null
          ? EuropeanHealthInsuranceCardIssuingCountryValues.includes(source.expectedCountry)
            ? source.expectedCountry
            : null
          : null;
    }
  }
...
*/
export class MrzFallbackConfiguration extends PartiallyConstructible {
  public readonly _type: 'MRZFallbackConfiguration' = 'MRZFallbackConfiguration';
  /**
    List of ISO 3166-1 alpha-3 country codes for which the MRZ fallback is enabled. (e.g. "DEU" for Germany).
    */
  public acceptedCountries: string[] = [];
  /**
    List of MRZ document types for which MRZ fallback is enabled.
    */
  public acceptedMRZTypes: MrzDocumentType[] = [];

  /** @param source {@displayType `DeepPartial<MrzFallbackConfiguration>`} */
  public constructor(source: DeepPartial<MrzFallbackConfiguration> = {}) {
    super();
    if (source.acceptedCountries !== undefined) {
      this.acceptedCountries = source.acceptedCountries.map((it: any) => {
        return it;
      });
    }
    if (source.acceptedMRZTypes !== undefined) {
      this.acceptedMRZTypes = source.acceptedMRZTypes.map((it: any) => {
        return it;
      });
    }
  }
...
*/
export class AutoFocusConfiguration extends PartiallyConstructible {
  public readonly _type: 'AutoFocusConfiguration' = 'AutoFocusConfiguration';
  /**
    ...
    Default is 0.02
    */
  public sensitivityThreshold: number = 0.02;

  /** @param source {@displayType `DeepPartial<AutoFocusConfiguration>`} */
  public constructor(source: DeepPartial<AutoFocusConfiguration> = {}) {
    super();
...
This configuration has no effect in SINGLE_SHOT mode.
*/
export class GlareDetectionConfiguration extends PartiallyConstructible {
  public readonly _type: 'GlareDetectionConfiguration' = 'GlareDetectionConfiguration';
  /**
    ...
    Default is 0.5
    */
  public glareDetectionThreshold: number = 0.5;

  /** @param source {@displayType `DeepPartial<GlareDetectionConfiguration>`} */
  public constructor(source: DeepPartial<GlareDetectionConfiguration> = {}) {
    super();
...
*/
export class DocumentDataExtractorCommonConfiguration extends PartiallyConstructible {
  public readonly _type: 'DocumentDataExtractorCommonConfiguration' =
    'DocumentDataExtractorCommonConfiguration';
  /**
    List of document types to scan. By default, the list is empty.
    */
  public acceptedDocumentTypes: string[] = [
    'DeIdCardFront',
    'DeIdCardBack',
  ...
  public constructor(source: DeepPartial<DocumentDataExtractorCommonConfiguration> = {}) {
    super();
    if (source.acceptedDocumentTypes !== undefined) {
      this.acceptedDocumentTypes = source.acceptedDocumentTypes.map((it: any) => {
        return it;
      });
    }
  }
