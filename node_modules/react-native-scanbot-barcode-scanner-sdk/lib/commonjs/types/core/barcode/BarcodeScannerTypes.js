...
var _GenericDocument = require("../generic_document/GenericDocument");
var _image = require("../image/image");
var _BarcodeConfigurationTypes = require("./BarcodeConfigurationTypes");
var _BarcodeTypes = require("./BarcodeTypes");
...
/** @hidden */
const BarcodeScannerEngineModeValues = exports.BarcodeScannerEngineModeValues = ['LEGACY', 'NEXT_GEN_LOW_POWER', 'NEXT_GEN', 'NEXT_GEN_LOW_POWER_FAR_DISTANCE', 'NEXT_GEN_FAR_DISTANCE', 'NEXT_GEN_MAX_DISTANCE'];
...
class BarcodeScannerConfiguration {
  ...
  /**
    ...
    */
  extractedDocumentFormats = ['AAMVA', 'BOARDING_PASS', 'DE_MEDICAL_PLAN', 'MEDICAL_CERTIFICATE', 'ID_CARD_PDF_417', 'SEPA', 'SWISS_QR', 'VCARD', 'GS1', 'HIBC', 'BRITISH_COLUMBIA_DRIVER_LICENSE'];
  /**
