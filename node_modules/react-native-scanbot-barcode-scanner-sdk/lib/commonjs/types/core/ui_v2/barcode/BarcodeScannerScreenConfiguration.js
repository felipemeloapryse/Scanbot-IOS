...
var _BarcodeTextLocalization = require("./BarcodeTextLocalization");
var _BarcodeUseCase = require("./BarcodeUseCase");
var _SingleScanningModeUseCase = require("./SingleScanningModeUseCase");
...
class BarcodeScannerScreenConfiguration {
  ...
  /**
    ...
    */
  scannerConfiguration = new _BarcodeScannerTypes.BarcodeScannerConfiguration({});
  /**
  ...
  constructor(source = {}) {
    ...
    if (source.scannerConfiguration !== undefined) {
      this.scannerConfiguration = new _BarcodeScannerTypes.BarcodeScannerConfiguration(source.scannerConfiguration);
    }
