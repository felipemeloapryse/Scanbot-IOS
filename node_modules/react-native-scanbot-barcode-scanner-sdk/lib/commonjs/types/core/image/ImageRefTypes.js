...
exports.SaveImageOptions = exports.RawImageLoadOptions = exports.PathLoadModeValues = exports.PathImageLoadOptions = exports.ImageSourceTypeValues = exports.ImageSource = exports.ImageRefProfile = exports.ImageRefPoolSnapshotsDiff = exports.ImageRefPoolSnapshot = exports.ImageProfile = exports.ImageInfo = exports.EncryptionModeValues = exports.EncodingFormatValues = exports.EncodeImageOptions = exports.ColorConversionValues = exports.CanvasColorValues = exports.BufferLoadModeValues = exports.BufferImageLoadOptions = exports.BasicImageLoadOptions = void 0;
var _JsonSerializationTypes = require("../common/JsonSerializationTypes");
var _ObjectPoolTypes = require("../utils/ObjectPoolTypes");
...
/** @hidden */
const ColorConversionValues = exports.ColorConversionValues = ['GRAY', 'COLOR', 'ANY_COLOR', 'UNCHANGED'];
...
/** @hidden */
const CanvasColorValues = exports.CanvasColorValues = ['WHITE', 'BLACK'];
...
/** @hidden */
const PathLoadModeValues = exports.PathLoadModeValues = ['EAGER', 'LAZY', 'LAZY_WITH_COPY'];
...
/** @hidden */
const BufferLoadModeValues = exports.BufferLoadModeValues = ['EAGER', 'LAZY'];
...
/** @hidden */
const EncodingFormatValues = exports.EncodingFormatValues = ['JPEG', 'PNG'];
...
/** @hidden */
const EncryptionModeValues = exports.EncryptionModeValues = ['REQUIRED', 'DISABLED', 'AUTO'];
...
/** @hidden */
const ImageSourceTypeValues = exports.ImageSourceTypeValues = ['API', 'PLATFORM_IMAGE', 'CAMERA', 'FILE', 'BUFFER', 'OTHER'];
...
class ImageRefProfile {
  ...
  constructor(source = {}) {
    if (source.refInfo !== undefined) {
      this.refInfo = new _ObjectPoolTypes.RefCountedObjectProfile(source.refInfo);
    } else {
...
//# sourceMappingURL=ImageRefTypes.js.map