...
import { BarcodeFormatCommonConfiguration, BarcodeFormatConfigurationBase } from './BarcodeConfigurationTypes';
import { RangeEncoding, StructuredAppendInfo } from './BarcodeTypes';
...
export class BarcodeItem {
  ...
  constructor(source = {}) {
    ...
    if (source.structuredAppendInfo !== undefined) {
      this.structuredAppendInfo = source.structuredAppendInfo != null ? new StructuredAppendInfo(source.structuredAppendInfo) : null;
    } else {
...
/** @hidden */
export const BarcodeScannerEngineModeValues = ['LEGACY', 'NEXT_GEN_LOW_POWER', 'NEXT_GEN', 'NEXT_GEN_LOW_POWER_FAR_DISTANCE', 'NEXT_GEN_FAR_DISTANCE', 'NEXT_GEN_MAX_DISTANCE'];
