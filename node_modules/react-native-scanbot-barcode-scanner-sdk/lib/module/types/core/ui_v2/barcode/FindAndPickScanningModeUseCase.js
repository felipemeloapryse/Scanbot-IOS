...
import { BackgroundStyle, BadgeStyle, BadgedButton, ButtonConfiguration, ForegroundStyle, IconStyle, PolygonStyle, StyledText } from '../common/Common';
import { ScanbotAlertDialog } from '../common/ScanbotAlertDialog';
import { ArOverlayFindAndPickConfiguration, FindAndPickArOverlayPolygonConfiguration, FindAndPickBadgeConfiguration } from './ArTrackingOverlayConfiguration';
import { ManualCountEditDialog, Sheet, SheetContent, SwipeToDelete } from './MultipleScanningModeUseCase';
...
(function (_ExpectedBarcode) {
  const BARCODE_IMAGE_KEY = _ExpectedBarcode.BARCODE_IMAGE_KEY = 'BARCODE_IMAGE';
...
export class FindAndPickScanningMode {
  ...
  /**
    ...
    */
  partialScannedAlertDialog = new ScanbotAlertDialog({
    title: new StyledText({
